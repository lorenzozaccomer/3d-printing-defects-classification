...
data_dir = 'L:\\test\\Images'

image_datasets = TEST__ImagesDatasetFromFolders(data_dir)

dataloaders = TEST__ShuffleDatasets(image_datasets)

dataset_sizes = TEST__ImagesDatasetSize(image_datasets)
